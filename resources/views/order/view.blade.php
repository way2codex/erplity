                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control customer_id select2" value="{{ $order->customer->name}}" readonly>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo date('d-m-Y', strtotime($order->due_date)); ?>" class="form-control" placeholder="Due Date" autocomplete="false" readonly />
                                    </div>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered w-100">
                                    <tbody>
                                        ...
                                        @foreach ($order->order_product as $key => $p)
                                        <tr>
                                            <th>{{$key+1}}. </th>
