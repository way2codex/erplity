                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form action="{{ route('store_supplier') }}" id='add_form' name="add_form" method="POST"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Mobile"
                                                        id='mobile' name="mobile" value="{{ old('mobile') }}" maxlength="10" minlength="10">
                                                        @error('mobile')
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Alternate Mobile"
                                                        id='alt_mobile' name="alt_mobile" value="{{ old('alt_mobile') }}" maxlength="10" minlength="10">
                                                        @error('alt_mobile')
