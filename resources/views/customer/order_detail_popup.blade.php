...
<div class="card-content collapse show">
    <div class="card-body">
        <?php if ($order['debit_amount'] > 0) { ?>
            <form action="{{ route('order_payment_store') }}" id='payment_add_form' name="payment_add_form" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" max="<?php echo $order['debit_amount']; ?>" class="form-control calculate_product_total discount" placeholder="Amount" id='amount' name="amount">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        <table style="margin-top:30px;" class="table-sm table table-bordered">
            ...
            <?php foreach ($order['order_product'] as $key => $product) { ?>
                <tr>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        $('.order_detail_modal_content').html('');
