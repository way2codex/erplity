                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                <form action="{{ route('update_customer') }}" id='add_form' name="add_form" method="POST"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Mobile"
                                                        id='mobile' name="mobile" value="{{ old('mobile',$customer->mobile) }}" maxlength="10" minlength="10">
                                                        @error('mobile')
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Alternate Mobile"
                                                        id='alt_mobile' name="alt_mobile" value="{{ old('alt_mobile',$customer->alt_mobile) }}" maxlength="10" minlength="10">
                                                        @error('alt_mobile')
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="status" name="status" class="select2 form-control">
                                                        <option <?php if (old('status',$customer['status']) == 1) {
                                                            echo 'selected';
                                                        } ?> value="1">Active</option>
                                                <option <?php if (old('status',$customer['status']) == 0) {
                                                            echo 'selected';
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <img src="{{ $customer['photo'] }}" style="width: 100px;border:2px solid #ff6a00;" id="image" alt="No Image Uploaded"/>
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
